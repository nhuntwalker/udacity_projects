...
```{r}
ggplot(data=all_info, aes(x=gdp_2000, y=life_expectancy_2000)) + geom_point()

ggplot(data=all_info, aes(x=life_expectancy_2000, y=female_unemployment_2000)) + geom_point()
```
