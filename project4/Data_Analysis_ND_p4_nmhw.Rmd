...
I was expecting. Let's see what the scatterplot says
...
I wonder if there's any visible difference when coloring on 
...
Somewhat. Smaller loans for those employed part time. A ton of borrowers 
are employed or self-employed though. Let's see the employment statuses of
borrowers more explicitly.
...
ggplot(data=subset(prosper, 
       ...
       aes(x=ListingCreationDate_decimal, y=LoanOriginalAmount)) + 
  geom_point(aes(color=factor(EmploymentStatus)), 
...
```{r}
ggplot(data=prosper, 
       aes(x=LoanOriginationDate_decimal, 
